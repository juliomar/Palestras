...
type
  ...
  public
    ...
    procedure TearDown;
    [Test]
    procedure ValidarSomenteNumeros; overload;

    [Test]
    [TestCase('Caso 1', 'A0-245%4$38&86893,024543886893')]
    [TestCase('Caso 2', '111.111.111-11,11111111111')]
    procedure ValidarSomenteNumeros(AStringASerValidada: String; AResultadoEsperado: String);overload;
...
begin
  ...
  Assert.AreEqual(Resultado , Aux, 'String de entrada A0-2,45%4$38&¨8689.3 deveria retornar 024543886893 mas retornou ' + Aux);
end;
